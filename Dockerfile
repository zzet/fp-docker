...
ENV LIBREOFFICEPACKAGE LibreOffice_5.0.4_Linux_x86-64_deb.tar.gz
ENV LIBREOFFICEDIR LibreOffice_5.0.4.2_Linux_x86-64_deb
RUN wget -q http://mirror.switch.ch/ftp/mirror/tdf/libreoffice/stable/5.0.4/deb/x86_64/$LIBREOFFICEPACKAGE -O /tmp/$LIBREOFFICEPACKAGE \
